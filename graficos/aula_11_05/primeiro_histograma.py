...
fig, ax = plt.subplots()
fig.set_size_inches(5.6, 4.2) # em polegadas

ax.hist(
    # bins de 1100 a 1900, de 50 a 50
    salaries, bins=np.arange(1100, 1900, 50), edgecolor="black", linewidth=1.2
)

# string com um dólar
formatter = ticker.FormatStrFormatter("$%1.0f")
ax.xaxis.set_major_formatter(formatter)
plt.title("Salários mensais no departamento de vendas.")
plt.xlabel("Salário (bin = 50)")
